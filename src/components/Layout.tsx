		...
		<nav className={`${isOpen ? 'visible opacity-100 transition-[opacity] delay-500' : 'invisible opacity-0'} z-10 absolute inset-0 grid grid-cols-8 grid-rows-6`}>
          ...
          <button onClick={() => setIsOpen(false)}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-24 h-24">
				...
				<div className="w-full h-full row-[3_/_span_3] col-span-8">
					<ul className="w-full h-full flex flex-col items-strecth justify-center text-center">
						<li className="grid md:grid-cols-8 py-2 border-t border-gray-700 transition hover:bg-red-400">
							<span className="md:col-[3] text-[72px]">Art</span>
							<span className="col-[5_/_span_2] hidden md:flex items-center text-justify">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In porta dictum orci ac gravida. Aliquam vel fringilla risus. Duis vel urna non leo sodales pulvinar eu sit amet orci. Praesent quam libero, iaculis vitae vestibulum vel, vulputate a erat.</span>
						</li>
						<li className="grid md:grid-cols-8 py-2 border-t border-gray-700 transition hover:bg-red-400">
							<span className="col-[2_/_span_3] hidden md:flex items-center text-justify">Praesent laoreet venenatis purus, et congue mauris luctus vitae. Nulla eget commodo nunc, vitae lacinia felis. Nunc faucibus placerat diam vitae auctor. Duis eleifend malesuada nisl. Quisque dapibus elit quis nisl convallis, eget tristique metus porttitor. Aenean quis dolor sed velit vulputate ornare eu nec ipsum. Aliquam erat volutpat.</span>
							<span className="md:col-[6] text-[72px]">Work</span>
						</li>
						<li className="grid md:grid-cols-8 py-2 border-y border-gray-700 transition hover:bg-red-400">
							<span className="md:col-[4] text-[72px]">Contact</span>
							<span className="col-[6_/_span_2] hidden md:flex items-center text-justify">Aliquam vel fringilla risus. Duis vel urna non leo sodales pulvinar eu sit amet orci. Praesent quam libero, iaculis vitae vestibulum vel, vulputate a erat.</span>
						</li>
					</ul>
				</div>
				<div className="row-[5] col-span-2 hidden md:flex items-center ml-16">
					<div className="h-full mr-8">
						<Image className="h-full w-full object-cover rounded-3xl" src="/an-art.jpg" width={360} height={360} alt="" />
					</div>
